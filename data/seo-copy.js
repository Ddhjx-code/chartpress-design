/**
 * ChartPress — SEO copy for programmatic size-chart pages.
 * Keyed by blank key (matches data/blanks.js).
 *
 * The build script generates <title> / <meta description> / H1 from
 * brand + model + name, and uses `blurb` as the unique body paragraph.
 */
const SEO_COPY = {
  gildan5000: {
    blurb: "The Gildan 5000 Heavy Cotton is the best-selling print-on-demand tee of all time. At 6.0 oz/yd² (203 GSM) of 100% preshrunk cotton, it's the heavyweight workhorse behind countless Etsy and TikTok Shop designs. It runs true to a classic unisex adult fit with a structured, boxy drape that holds its shape wash after wash — the safe default when you're not sure what your buyer expects.",
  },
  gildan5000b: {
  ...
  gildan64000: {
    blurb: "The Gildan 64000 Softstyle is the lighter, softer sibling of the 5000. At 4.5 oz/yd² of 100% ring-spun cotton, it has a smoother, more fashion-forward hand and a slightly slimmer cut — the go-to when you want a tee that feels premium rather than utilitarian. Popular for boutique and streetwear-style POD shops that find the 5000 too heavy. Gildan measures sleeve from center back (center neckline, across the shoulder, to the cuff).",
  },
  gildan18500: {
  ...
  gildan18000: {
    blurb: "The Gildan 18000 Heavy Blend Crewneck is a print-on-demand staple for fall and winter. Built on the same 8.0 oz/yd² 60/40 polyester-cotton Heavy Blend fleece as the 18500 hoodie, it's the classic pullover sweatshirt — warm, durable, and pill-resistant, with a clean crew neckline that takes prints and embroidery well. Pair it with the matching 18500 hoodie for a full apparel line. Gildan measures sleeve from center back (center neckline, across the shoulder, to the cuff).",
  },
  gildan18000b: {
